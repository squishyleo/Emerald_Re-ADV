...
const u8 gTypeEffectiveness[336] =
{
    ...
    TYPE_POISON, TYPE_DRAGON, TYPE_MUL_SUPER_EFFECTIVE, // Poison super effective againt Dragon
    ...
    // TYPE_GROUND, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE, Rock no longer weak againts Ground
    ...
    // TYPE_ROCK, TYPE_ICE, TYPE_MUL_SUPER_EFFECTIVE, Ice no longer weak against Rock
...
{
    {TRAINER_CLASS_TEAM_AQUA, 7}, // 5
    {TRAINER_CLASS_AQUA_ADMIN, 15}, // 10
    {TRAINER_CLASS_AQUA_LEADER, 25}, // 20
    {TRAINER_CLASS_AROMA_LADY, 15}, // 10
    {TRAINER_CLASS_RUIN_MANIAC, 17}, // 15
    {TRAINER_CLASS_INTERVIEWER, 16}, // 12
    {TRAINER_CLASS_TUBER_F, 1},
    {TRAINER_CLASS_TUBER_M, 1},
    {TRAINER_CLASS_SIS_AND_BRO, 3},
    {TRAINER_CLASS_COOLTRAINER, 16}, // 12
    {TRAINER_CLASS_HEX_MANIAC, 9}, // 6
    {TRAINER_CLASS_LADY, 50},
    {TRAINER_CLASS_BEAUTY, 30}, // 20
    {TRAINER_CLASS_RICH_BOY, 50},
    {TRAINER_CLASS_POKEMANIAC, 20}, // 15
    {TRAINER_CLASS_SWIMMER_M, 2},
    {TRAINER_CLASS_BLACK_BELT, 8},
    {TRAINER_CLASS_GUITARIST, 8},
    {TRAINER_CLASS_KINDLER, 8},
    {TRAINER_CLASS_CAMPER, 4},
    {TRAINER_CLASS_OLD_COUPLE, 15}, // 10
    {TRAINER_CLASS_BUG_MANIAC, 20},  // 15
    {TRAINER_CLASS_PSYCHIC, 9}, // 6
    {TRAINER_CLASS_GENTLEMAN, 30}, // 20
    {TRAINER_CLASS_ELITE_FOUR, 35}, // 25
    {TRAINER_CLASS_LEADER, 35}, // 25
    {TRAINER_CLASS_SCHOOL_KID, 5},
    {TRAINER_CLASS_SR_AND_JR, 4},
    {TRAINER_CLASS_POKEFAN, 25}, // 20
    {TRAINER_CLASS_EXPERT, 15}, // 10
    {TRAINER_CLASS_YOUNGSTER, 4},
    {TRAINER_CLASS_CHAMPION, 75}, // 50
    {TRAINER_CLASS_FISHERMAN, 15}, // 10
    {TRAINER_CLASS_TRIATHLETE, 17}, // 10
    {TRAINER_CLASS_DRAGON_TAMER, 16}, // 12 
    {TRAINER_CLASS_BIRD_KEEPER, 12}, // 8
    {TRAINER_CLASS_NINJA_BOY, 3},
    {TRAINER_CLASS_BATTLE_GIRL, 6},
    {TRAINER_CLASS_PARASOL_LADY, 17}, // 10
    {TRAINER_CLASS_SWIMMER_F, 2},
    {TRAINER_CLASS_PICNICKER, 4},
    {TRAINER_CLASS_TWINS, 3},
    {TRAINER_CLASS_SAILOR, 8},
    {TRAINER_CLASS_COLLECTOR, 20}, //15
    {TRAINER_CLASS_RIVAL, 25}, // 15
    {TRAINER_CLASS_PKMN_BREEDER, 10},
    {TRAINER_CLASS_PKMN_RANGER, 12},
    {TRAINER_CLASS_TEAM_MAGMA, 7}, // 5
    {TRAINER_CLASS_MAGMA_ADMIN, 15}, // 10
    {TRAINER_CLASS_MAGMA_LEADER, 25}, // 20
    {TRAINER_CLASS_LASS, 4},
    {TRAINER_CLASS_BUG_CATCHER, 4},
    {TRAINER_CLASS_HIKER, 10},
    {TRAINER_CLASS_YOUNG_COUPLE, 8},
    {TRAINER_CLASS_WINSTRATE, 20}, // 10
    {0xFF, 10}, // Any trainer class not listed above uses this , 5
};
