static const struct TrainerMonNoItemDefaultMoves sParty_Sawyer1[] = {
    ...
    .iv = 0,
    .lvl = 29, // 21
    .species = SPECIES_GRAVELER, // GEODUDE
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_GruntMuseum2[] = {
    ...
    .iv = 0,
    .lvl = 17, // 14
    .species = SPECIES_CORPHISH, // CARVANHA
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Lola1[] = {
    ...
    .iv = 10,
    .lvl = 16, // 12
    .species = SPECIES_SLOWPOKE, // AZURILL
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ricky1[] = {
    ...
    .lvl = 16, // 13
    .species = SPECIES_ZIGZAGOON,
    .moves = {MOVE_SAND_ATTACK, MOVE_HEADBUTT, MOVE_CHARM, MOVE_SURF} // CHARM REPLACES TAIL WHIP
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Simon[] = {
    ...
    .iv = 0,
    .lvl = 16, // 12
    .species = SPECIES_SHELLDER, // AZURILL
    },
    {
    .iv = 0,
    .lvl = 16, // 12
    .species = SPECIES_HORSEA, // MARILL
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Wilton1[] = {
    ...
    .iv = 100,
    .lvl = 23, // 17
    .species = SPECIES_GROWLITHE, // ELEKTRIKE
    },
    {
    .iv = 100,
    .lvl = 23, // 17
...
static const struct TrainerMonNoItemDefaultMoves sParty_Brooke1[] = {
    ...
    .iv = 100,
    .lvl = 23, // 17
    .species = SPECIES_PIDGEOTTO, // WINGULL
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_VULPIX, // NUMEL
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_TANGELA, // ROSELIA
    }
};
...
static const struct TrainerMonItemDefaultMoves sParty_Cindy1[] = {
    ...
    .iv = 0,
    .lvl = 9, //7
    .species = SPECIES_VULPIX, //ZIGZAGOON
...
static const struct TrainerMonNoItemDefaultMoves sParty_Melissa[] = {
    ...
    .iv = 0,
    .lvl = 29, // 21
    .species = SPECIES_PIKACHU, // MARILL
    }
};
...
static const struct TrainerMonItemDefaultMoves sParty_Winston1[] = {
    ...
    .iv = 0,
    .lvl = 9,
    .species = SPECIES_GROWLITHE, //ZIGZAGOON
    .heldItem = ITEM_NUGGET
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Steve1[] = {
    ...
    .iv = 0,
    .lvl = 26, // 19
    .species = SPECIES_GIRAFARIG, // ARON
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Bernie1[] = {
    ...
    .iv = 0,
    .lvl = 26, // 18
    .species = SPECIES_WOOPER, // WINGULL
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Shane[] = {
    ...
    .iv = 0,
    .lvl = 26, // 18
    .species = SPECIES_CUBONE, // sandshrew
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Travis[] = {
    ...
    .iv = 0,
    .lvl = 23, // 18
    .species = SPECIES_YANMA, // SANDSHREW
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .species = SPECIES_CACTURNE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LEECH_SEED, MOVE_KNOCK_OFF, MOVE_NEEDLE_ARM, MOVE_SANDSTORM}
    },
    {
    .iv = 250,
    .lvl = 64,
    .species = SPECIES_MIGHTYENA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HOWL, MOVE_DOUBLE_EDGE, MOVE_IRON_TAIL, MOVE_CRUNCH}
    },
    {
    .iv = 250,
    .lvl = 65,
    .species = SPECIES_SHIFTRY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BRICK_BREAK, MOVE_LEAF_BLADE, MOVE_FAINT_ATTACK, MOVE_EXTRASENSORY}
    },
    {
    .iv = 250,
    .lvl = 65,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICE_PUNCH, MOVE_SWORDS_DANCE, MOVE_KNOCK_OFF, MOVE_LOW_KICK}
    },
    {
    .iv = 255,
    .lvl = 66,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_AERIAL_ACE, MOVE_ROCK_SLIDE, MOVE_SWORDS_DANCE, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_CONFUSE_RAY, MOVE_PSYCHIC, MOVE_PAIN_SPLIT}
    },
    {
    .iv = 250,
    .lvl = 66,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_PUNCH, MOVE_CURSE, MOVE_EARTHQUAKE, MOVE_WILL_O_WISP}
    },
    {
    .iv = 250,
    .lvl = 66,
    .species = SPECIES_SABLEYE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_CONFUSE_RAY, MOVE_ROCK_SLIDE, MOVE_FAINT_ATTACK} 
    },
    {
    .iv = 250,
    .lvl = 66,
    ...
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = { MOVE_SHADOW_BALL, MOVE_THUNDERBOLT, MOVE_FAINT_ATTACK, MOVE_ICE_BEAM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HAIL, MOVE_THUNDERBOLT, MOVE_SHADOW_BALL, MOVE_BLIZZARD}
    },
    {
    .iv = 250,
    .lvl = 69,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_DOUBLE_EDGE, MOVE_ANCIENT_POWER, MOVE_BLIZZARD}
    },
       {
    .iv = 250,
    .lvl = 68,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_HAIL, MOVE_SHADOW_BALL, MOVE_BLIZZARD}
    },
    // {
    // .iv = 250,
    // .lvl = 69,
    ...
    // .heldItem = ITEM_NONE,
    // .moves = {MOVE_WATER_PULSE, MOVE_HAIL, MOVE_BLIZZARD, MOVE_ENCORE} // MOVE_EARTHQUAKE, MOVE_SPIKES, MOVE_ANCIENT_POWER, MOVE_ICE_BEAM
    // },
    {
    .iv = 250,
    .lvl = 69,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LOVELY_KISS, MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_BLIZZARD}
    },
    {
    .iv = 255,
    .lvl = 70,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SURF, MOVE_BODY_SLAM, MOVE_BLIZZARD, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_DRAGON_BREATH, MOVE_DRAGON_DANCE, MOVE_DRILL_PECK}
    },
    {
    .iv = 250,
    .lvl = 70,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_DRAGON_BREATH, MOVE_DRAGON_DANCE, MOVE_DRILL_PECK} // MOVE_EARTHQUAKE, MOVE_DRAGON_BREATH, MOVE_DRAGON_DANCE, MOVE_DRILL_PECK
    },
    {
    .iv = 250,
    .lvl = 70,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AERIAL_ACE, MOVE_SIGNAL_BEAM, MOVE_DRAGON_CLAW, MOVE_ANCIENT_POWER}
    },
    {
    .iv = 250,
    .lvl = 70,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EXTREME_SPEED, MOVE_AERIAL_ACE, MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 71,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLAMETHROWER, MOVE_DRAGON_CLAW, MOVE_ROCK_SLIDE, MOVE_AERIAL_ACE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .species = SPECIES_RHYHORN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HORN_ATTACK, MOVE_TAIL_WHIP, MOVE_MAGNITUDE, MOVE_ROCK_TOMB}
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_LARVITAR, //GEODUDE
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_BITE, MOVE_LEER, MOVE_ROCK_TOMB}
    },
    {
    .iv = 200,
    .lvl = 18,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .species = SPECIES_MEDITITE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_KARATE_CHOP, MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_CONFUSION}
    },
    {
    .iv = 100,
    .lvl = 22,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_KARATE_CHOP, MOVE_PURSUIT, MOVE_ROCK_THROW, MOVE_BULK_UP}
    },
    {
    .iv = 200,
    .lvl = 23,
    .species = SPECIES_MAKUHITA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ARM_THRUST, MOVE_SMELLING_SALT, MOVE_GLARE, MOVE_BULK_UP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCK_WAVE, MOVE_ICE_PUNCH, MOVE_CONFUSE_RAY, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 220,
    .lvl = 26,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BULLET_SEED, MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE, MOVE_BRICK_BREAK}
    },
    {
    .iv = 250,
    .lvl = 27,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_BITE, MOVE_SHOCK_WAVE, MOVE_EMBER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .iv = 200,
    .lvl = 31,
    .species = SPECIES_CHARMELEON, // CHARMELEON
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_MAGNITUDE, MOVE_METAL_CLAW, MOVE_SUNNY_DAY}
    },
    {
    .iv = 200,
    .lvl = 32,
    .species = SPECIES_RAPIDASH, // RAPIDASH
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_SHOCK_WAVE, MOVE_LIGHT_SCREEN, MOVE_HORN_ATTACK}
    },
    {
    .iv = 250,
    .lvl = 32,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_MAGNITUDE, MOVE_BRICK_BREAK, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = 250,
    .lvl = 34,
    ...
    .moves = {MOVE_OVERHEAT, MOVE_SUNNY_DAY, MOVE_BODY_SLAM, MOVE_SOLAR_BEAM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .species = SPECIES_VIGOROTH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HOWL, MOVE_FACADE, MOVE_AERIAL_ACE, MOVE_FAINT_ATTACK}
    },
    {
    .iv = 200,
    .lvl = 38,
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SLASH, MOVE_BELLY_DRUM, MOVE_FACADE, MOVE_POISON_FANG}
    },
    {
    .iv = 250,
    .lvl = 40,
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TOXIC, MOVE_SPIKES, MOVE_STEEL_WING, MOVE_AERIAL_ACE}
    },
    {
    .iv = 210,
    .lvl = 43,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HAIL, MOVE_AERIAL_ACE, MOVE_BLIZZARD, MOVE_PRESENT}
    },
    {
    .iv = 210,
    .lvl = 43,
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_PULSE, MOVE_SUPERSONIC, MOVE_RAIN_DANCE, MOVE_AERIAL_ACE}
    },
    {
    .iv = 210,
    .lvl = 44,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .species = SPECIES_STARMIE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_PULSE, MOVE_ANCIENT_POWER, MOVE_PSYCHIC, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 250,
    .lvl = 48,
    .species = SPECIES_GRUMPIG,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_BOUNCE, MOVE_CONFUSE_RAY, MOVE_CALM_MIND}
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .species = SPECIES_SOLROCK,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ROCK_SLIDE, MOVE_SOLAR_BEAM, MOVE_PSYCHIC, MOVE_FLAMETHROWER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .iv = 200,
    .lvl = 56,
    .species = SPECIES_WHISCASH, // final poke
    .heldItem = ITEM_NONE,
    ...
    .iv = 200,
    .lvl = 57,
    .species = SPECIES_DEWGONG, // huntail
    .heldItem = ITEM_NONE,
    ...
    .iv = 200,
    .lvl = 58,
    .species = SPECIES_CRAWDAUNT, // gorebyss
    .heldItem = ITEM_NONE,
    ...
    .iv = 250,
    .lvl = 60,
    .species = SPECIES_KINGDRA, // politoed , not final poke
...
static const struct TrainerMonNoItemDefaultMoves sParty_Karen1[] = {
    ...
    .iv = 10,
    .lvl = 14, //9
    .species = SPECIES_BULBASAUR, //SHROOMISH
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Calvin1[] = {
    ...
    .iv = 0,
    .lvl = 6, //5
    .species = SPECIES_ZIGZAGOON, //POOCHYENA
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Billy[] = {
    ...
    .iv = 0,
    .lvl = 7, //5
    .species = SPECIES_RATTATA, //ZIGZAGOON
    },
    {
    .iv = 0,
    .lvl = 7,
...
static const struct TrainerMonNoItemCustomMoves sParty_Josh[] = {
    ...
    .moves = {MOVE_TACKLE, MOVE_GROWL, MOVE_ROCK_THROW, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Joey[] = {
    ...
    .iv = 0,
    .lvl = 13, //9
    .species = SPECIES_TYROGUE, //MACHOP
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ben[] = {
    ...
    .iv = 150,
    .lvl = 23, // 17
    .species = SPECIES_MAGNEMITE, // ZOGZAGOON
    .moves = {MOVE_TAKE_DOWN, MOVE_METAL_SOUND, MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Allen[] = {
    ...
    .iv = 0,
    .lvl = 6, //4
    .species = SPECIES_POOCHYENA, //ZIGZAGOON
    },
    {
    .iv = 0,
    .lvl = 5, //3
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .species = SPECIES_WAILORD,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAIN_DANCE, MOVE_WATER_SPOUT, MOVE_BODY_SLAM, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 75,
    ...
    .species = SPECIES_WHISCASH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_SURF, MOVE_RAIN_DANCE, MOVE_BODY_SLAM}
    },
    {
    .iv = 255,
    .lvl = 75,
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_SURF}
    },
    {
    .iv = 255,
    .lvl = 76,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CALM_MIND, MOVE_SURF, MOVE_ICE_BEAM, MOVE_TOXIC}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Ivan[] = {
    ...
    .iv = 0,
    .lvl = 9, //6
    .species = SPECIES_POLIWAG, //MAGIKARP
    },
    {
    .iv = 0,
    .lvl = 10, //7
    .species = SPECIES_PSYDUCK, //MAGIKARP
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Elliot1[] = {
    ...
    .iv = 0,
    .lvl = 16, // 8
    .species = SPECIES_CHINCHOU, // TENTACOOL
    },
    {
    .iv = 0,
    .lvl = 17,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Ned[] = {
    ...
    .iv = 10,
    .lvl = 17, // 11
    .species = SPECIES_REMORAID, // TENTACOOL
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Dale[] = {
    ...
    .iv = 0,
    .lvl = 17, // 11
    .species = SPECIES_BARBOACH, // TENTACOOL
    },
    {
    .iv = 0,
    .lvl = 18, // 14
    ...
    .iv = 0,
    .lvl = 17, // 11
    .species = SPECIES_WOOPER, // TENTACOOL
    },
    {
    .iv = 0,
    .lvl = 18, // 14
    .species = SPECIES_SHELLDER, // WAILMER
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Jocelyn[] = {
    ...
    .iv = 127,
    .lvl = 18, // 13
    .species = SPECIES_MANKEY, // MEDITITE
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline1[] = {
    ...
    .iv = 0,
    .lvl = 25, // 18
    .species = SPECIES_FLAREON, // NUMEL
    .moves = {MOVE_EMBER, MOVE_TACKLE, MOVE_BITE, MOVE_SUNNY_DAY} // MAGNITUDE->BITE
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Edmond[] = {
    ...
    .iv = 0,
    .lvl = 17, // 13
    .species = SPECIES_KRABBY, // WINGULL
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR1[] = {
    ...
    .lvl = 44,
    .species = SPECIES_ROSELIA,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_TOXIC} // MAGICAL_LEAF
    },
    {
    .iv = 150,
    .lvl = 41,
    .species = SPECIES_MAGNETON,
    .moves = {MOVE_SUPERSONIC, MOVE_THUNDERBOLT, MOVE_TRI_ATTACK, MOVE_METAL_SOUND}
    },
    {
    .iv = 250,
    .lvl = 45,
    .species = SPECIES_GARDEVOIR,
    .moves = {MOVE_SHADOW_BALL, MOVE_CALM_MIND, MOVE_PSYCHIC, MOVE_FUTURE_SIGHT} // DOUBLE_TEAM
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_BrendanRoute110Mudkip[] = {
    ...
    .iv = 50,
    .lvl = 21, //18
    .species = SPECIES_VULPIX, // WINGULL
    },
    {
    .iv = 50,
    .lvl = 21,
    .species = SPECIES_PLUSLE, // NEW
    },
    {
    .iv = 50,
    .lvl = 21,
    .species = SPECIES_TAILLOW, // SLUGMA
    },
    {
    .iv = 100,
    .lvl = 23,
...
static const struct TrainerMonNoItemDefaultMoves sParty_BrendanRoute110Treecko[] = {
    ...
    .iv = 50,
    .lvl = 21, //18
    .species = SPECIES_MARILL, // WINGULL
    },
    {
    .iv = 50,
    .lvl = 21,
...
static const struct TrainerMonNoItemDefaultMoves sParty_BrendanRoute110Torchic[] = {
    ...
    .iv = 50,
    .lvl = 21, //18
    .species = SPECIES_SHROOMISH, // WINGULL
    },
    {
    .iv = 50,
    .lvl = 21,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Lydia1[] = {
    ...
    .iv = 0,
    .lvl = 17, // 11
    .species = SPECIES_PIDGEY, // WINGULL
    },
    {
    .iv = 0,
    .lvl = 17, // 11
    .species = SPECIES_SWINUB, // shroomish
    },
    {
    .iv = 0,
    .lvl = 17, // 11
    .species = SPECIES_CYNDAQUIL, // MARILL
    },
    {
    .iv = 0,
    .lvl = 17, // 11
    .species = SPECIES_CHIKORITA, // ROSELIA
    },
    {
    .iv = 0,
    .lvl = 17, // 11
    ...
    .iv = 0,
    .lvl = 17, // 11
    .species = SPECIES_TOTODILE, // GOLDEEN
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_BrendanRustboroTreecko[] = {
    ...
    .iv = 25,
    .lvl = 18, // 13
    .species = SPECIES_AZURILL, // LOTAD
    },
    {
    .iv = 25,
    .lvl = 18, // NEW
    .species = SPECIES_TAILLOW, // NEW
    },
    {
    .iv = 50,
    .lvl = 19, // 15
...
static const struct TrainerMonNoItemDefaultMoves sParty_BrendanRustboroTorchic[] = {
    ...
    .iv = 25,
    .lvl = 18, // 13
    .species = SPECIES_SHROOMISH, // SLUGMA
    },
    {
    .iv = 25,
    .lvl = 18, // NEW
...
static const struct TrainerMonNoItemDefaultMoves sParty_MayRustboroMudkip[] = {
    ...
    .iv = 25,
    .lvl = 18, // NEW
    .species = SPECIES_VULPIX, // NEW
    },
    {
    .iv = 25,
    .lvl = 18, // 13
    .species = SPECIES_TAILLOW, // WINGULL
    },
    {
    .iv = 50,
    .lvl = 19, // 15
...
static const struct TrainerMonNoItemDefaultMoves sParty_Haley1[] = {
    ...
    .iv = 0,
    .lvl = 9, //6
    .species = SPECIES_CLEFFA, //LOTAD
    },
    {
    .iv = 0,
    .lvl = 10, //6
    .species = SPECIES_SURSKIT, //SHROOMISH
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Janice[] = {
    ...
    .iv = 10,
    .lvl = 12, //9
    .species = SPECIES_CLEFAIRY, //MARILL
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Rick[] = {
    ...
    .iv = 0,
    .lvl = 5, //4
    .species = SPECIES_CATERPIE, //WURMPLE
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Jose[] = {
    ...
    .iv = 50,
    .lvl = 13, //8
    .species = SPECIES_VENONAT, //WURMPLE
    },
    {
    .iv = 50,
    .lvl = 13, //8
    .species = SPECIES_WEEDLE, //NINCADA
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Lenny[] = {
    ...
    .iv = 0,
    .lvl = 26, // 18
    .species = SPECIES_RHYHORN, // GEODUDE
    },
    {
    .iv = 0,
    .lvl = 26, // 18
...
static const struct TrainerMonNoItemCustomMoves sParty_Gerald[] = {
    ...
    .moves = {MOVE_FLAMETHROWER, MOVE_DIG, MOVE_FAINT_ATTACK, MOVE_BODY_SLAM}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Danielle[] = {
    ...
    .moves = {MOVE_HYPNOSIS, MOVE_STOMP, MOVE_CONFUSION, MOVE_FLAME_WHEEL}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyMauville[] = {
    ...
    .lvl = 22, // 16
    .species = SPECIES_RALTS,
    .moves{MOVE_CONFUSION, MOVE_GROWL, MOVE_HYPNOSIS, MOVE_CONFUSE_RAY} // ADDED MOVESET
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR2[] = {
    ...
    .lvl = 48,
    .species = SPECIES_GARDEVOIR,
    .moves = {MOVE_CONFUSE_RAY, MOVE_CALM_MIND, MOVE_PSYCHIC, MOVE_THUNDERBOLT} // FUTURE_SIGHT , DOUBLE TEAM
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_TyraAndIvy[] = {
    ...
    .lvl = 27, // 20
    .species = SPECIES_GRAVELER,
    .moves = {MOVE_DEFENSE_CURL, MOVE_ROLLOUT, MOVE_BRICK_BREAK, MOVE_MAGNITUDE}
    }
};
...
static const struct TrainerMonItemDefaultMoves sParty_Dawson[] = {
    ...
    .iv = 0,
    .lvl = 15, //8
    .species = SPECIES_SENTRET, //ZIGZAGOON
    .heldItem = ITEM_NUGGET
    },
    {
    .iv = 0,
    .lvl = 15, //8
    .species = SPECIES_GROWLITHE, //POOCHYENA
    .heldItem = ITEM_NONE
    }
};
...
static const struct TrainerMonItemDefaultMoves sParty_Sarah[] = {
    ...
    .iv = 0,
    .lvl = 15, //8
    .species = SPECIES_BELLSPROUT, //LOTAD
    .heldItem = ITEM_NONE
    },
    {
    .iv = 0,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Chandler[] = {
    ...
    .iv = 0,
    .lvl = 16, // 12
    .species = SPECIES_POLIWAG, // TENTACOOL
    },
    {
    .iv = 0,
    .lvl = 16, // 12
    .species = SPECIES_PSYDUCK, // TENTACOOL
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Joseph[] = {
    ...
    .iv = 0,
    .lvl = 19, // 14
    .species = SPECIES_PIKACHU, // ELECTRIKE
    },
    {
    .iv = 0,
    .lvl = 19, // 14
...
static const struct TrainerMonNoItemDefaultMoves sParty_Alyssa[] = {
    ...
    .iv = 0,
    .lvl = 19,
    .species = SPECIES_NIDORINA, // MAGNEMITE
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Angelina[] = {
    ...
    .iv = 0,
    .lvl = 26, // 18
    .species = SPECIES_SURSKIT, // LOMBRE
    },
    {
    .iv = 0,
    .lvl = 26, // 18
    .species = SPECIES_SPOINK, // MARILL
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Johnson[] = {
    ...
    .iv = 0,
    .lvl = 13, //8
    .species = SPECIES_ODDISH, //SHROOMISH
    },
    {
    .iv = 0,
    .lvl = 13, //8
    .species = SPECIES_POLIWAG, //LOTAD
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Melina[] = {
    ...
    .iv = 0,
    .lvl = 17,
    .species = SPECIES_SNUBBULL, // DODUO
    }
};
