const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL, 37, SPECIES_SLOWBRO},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_SLOWKING}}, //EVO_TRADE_ITEM, ITEM_KINGS_ROCK,
    ...
    [SPECIES_PORYGON]    = {{EVO_ITEM, ITEM_UP_GRADE, SPECIES_PORYGON2}}, //EVO_TRADE_ITEM
    ...
    [SPECIES_TORCHIC]    = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_COMBUSKEN}}, //EVO_LEVEL, 16,
    ...
    [SPECIES_CLAMPERL]   = {{EVO_ITEM, ITEM_DEEP_SEA_TOOTH, SPECIES_HUNTAIL}, //EVO_TRADE_ITEM
                            {EVO_ITEM, ITEM_DEEP_SEA_SCALE, SPECIES_GOREBYSS}}, //EVO_TRADE_ITEM
