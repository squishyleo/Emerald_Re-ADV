...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    [SPECIES_YANMA] =
    {
        ...
        .baseDefense   = 45,
        .baseSpeed     = 95,
        .baseSpAttack  = 95, //i forgot lol
        .baseSpDefense = 45,
        .types = { TYPE_BUG, TYPE_DRAGON }, //not flying anymore
        .catchRate = 75,
        .expYield = 147,
        .evYield_HP        = 0,
        .evYield_Attack    = 0,
