const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    [MOVE_BLIZZARD] =
    {
        .effect = EFFECT_BLIZZARD, // CHANGED FROM EFFECT_FREEZE_HIT
        .power = 120,
        .type = TYPE_ICE,
        .accuracy = 80, //70
        .pp = 10,
    ...
    [MOVE_GROWTH] =
    {
        .effect = EFFECT_SPECIAL_ATTACK_UP_2, //EFFECT_SPECIAL_ATTACK_UP
        .power = 0,
        .type = TYPE_GRASS,
        .accuracy = 0,
        .pp = 40,
    ...
    [MOVE_CLAMP] =
    {
        .effect = EFFECT_TRAP,
        .power = 35,
        .type = TYPE_ICE, // WATER, WHIRLPOOL ALREADY EXISTS, SO IT SEEMS REDUNDANT
        .accuracy = 90, //75
        .pp = 20, // 15
        .secondaryEffectChance = 100,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_SHARPEN] =
    {
        .effect = EFFECT_ATTACK_UP_2, // +2 ATTACK
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 0,
        .pp = 30,
